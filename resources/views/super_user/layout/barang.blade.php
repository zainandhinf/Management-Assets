...
@section('content')
    <div class="card p-4" style="font-size: 14px;">
        ...
        @else
            <b>
                <h5>
                    *Note: Data Barang hanya bisa dibuat ketika kamu sudah mengisi <a href="/kategori-barang">Data Kategori
                        Barang</a> terlebih dahulu !
                </h5>
            </b>
        @endif
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  is-invalid
              @enderror"
                                placeholder="No Barang.." style="background: #eee;" id="name" name="no_barang"
                            ...
                            <input value="{{ old('kode_awal') }}" style="font-size: 14px;" type="text"
                                ...
                                is-invalid
                                @enderror"
                                placeholder="Masukan kode unik untuk no. asset(KL atau MS atau LP).." id="name"
                                name="kode_awal">
                            @error('kode_awal')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <form action="/editbarang" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input name="no_barang" style="font-size: 14px;" type="text"
                                    class="form-control @error('no_barang') fs-6 is-invalid @enderror"
                                    placeholder="No Barang.." id="name" value="{{ $barang->no_barang }}" readonly>
                                @error('no_barang')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <input name="nama_barang" style="font-size: 14px;" type="text"
                                    class="form-control @error('kode_aktiva') fs-6 is-invalid @enderror"
                                    placeholder="Nama Barang.." id="name" value="{{ $barang->nama_barang }}"
                                    required>
                                @error('nama_barang')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                ...
                                <select style="font-size: 14px;"
                                    class="form-select @error('id_kategori') is-invalid @enderror" name="id_kategori">

                                    <option value="{{ $barang->id_kategori }}" selected>
                                        <b>{{ $barang->nama_kategori }}(Selected Now)</b></option>
                                ...
                                <input name="qty" style="font-size: 14px;" type="hidden"
                                    class="form-control @error('kode_aktiva') fs-6 is-invalid @enderror"
                                    placeholder="Nama Barang.." id="name" value="{{ $barang->qty }}" required>
                                @error('qty')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <table class="table table-striped" id="data-tables" style="font-size: 14px;">
                            ...
                            @foreach ($details as $detail)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button data-bs-toggle="modal" data-bs-target="#seefoto{{ $detail->no_barang }}"
            ...
            <div class="modal-dialog w-50 modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <h6>Are you sure?</h6>
                        <div class="text-muted">Yakin? Anda akan menghapus data ini <br> (Nama Barang:
                            *<b>{{ $barang->nama_barang }}</b>)...</div>
                    </div>
                    <div class="modal-footer">
                        <div class="w-100">
                            <div class="row">
