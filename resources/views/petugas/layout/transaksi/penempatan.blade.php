            ...
            @foreach ($barangs as $barang)
                <tr>
                    ...
                    <td>No Barang: <b>{{ $barang->no_barang }}</b> <br>Barcode:
                        <b>{!! DNS1D::getBarcodeHTML($barang->kode_barcode, 'UPCA') !!}{{ $barang->kode_barcode }}</b> <br>No
                        Asset: <b>{{ $barang->no_asset }}</b>
                    </td>
                    <td>{{ $barang->merk }}, {{ $barang->spesifikasi }}</td>
                    <td>{{ $barang->tanggal_penempatan }}</td>
                    {{-- <td>{{ $barang->jenis_pengadaan }}</td> --}}
                    <td>{{ $barang->lokasi_penempatan }}</td>
                    ...
                    <table class="table table-striped" id="data-tables-keranjang">
                        ...
                        @foreach ($barangs as $barang)
                            ...
                            <tr>
                                ...
                                <td class="@if($barang->status == "Belum Ditempatkan")bg-warning @endif">{{ $barang->status }}</td>
                                <td>Rp. {{ number_format($barang->harga) }}</td>
                                {{-- <td>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ut, ipsa.</td> --}}
                                {{-- <td>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ut, ipsa.</td> --}}
                                <td>{{ $barang->keterangan }}</td>
